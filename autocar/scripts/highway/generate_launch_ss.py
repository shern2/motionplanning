...
### ss: Modified the following:
## highway_ss.yaml
# '<node name="map_server" pkg="map_server" type="map_server" args="$(find autocar)/maps/world/highway_ss.yaml">\n'+\
## nameSpace ns AND frame_id's
# ns="/robot_ to ns="robot_
# value="/robot_' to value="robot_'
## RViz camera settings
# '    <node name="rviz" pkg="rviz" type="rviz" args="-d $(find autocar)/maps/rviz_settings/highway_simu_ss.rviz"/>\n' +\
